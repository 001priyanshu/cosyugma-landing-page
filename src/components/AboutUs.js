...
export default function AboutUs() {
    return (
        <div className='top-space'>
           <div className='about-container'>
            ...
            <div className='about-info row animatedParent'>
            ...
            <div className='row animatedParent'>
                <div className='col-xl-2 col-lg-4 col-md-4 col-sm-12 col-xs-12 about-count-colm animated fadeInUpShort delay-250 go '>
            ...
            <div className='row animatedParent about-intro'>
      <div className='col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 about-intro-colm' >
    ...
    <div className='row'>
        <div className='offset-xl-2 offset-lg-2 offset-m-0 offset-sm-0 offset-xs-0 col-xl-8 col-lg-8 col-md-12 col-sm-12 col-xs-12 welcome-word'>
